...
export const EVAL_DATASET: EvalCase[] = [
  ...
  { category: 'WRITE_DETECTION_ONLY', text: 'Retiré utilidad para César.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', allowedConfidence: ['MEDIUM', 'LOW', 'HIGH'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Retiré 50 mil de utilidad para César.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', expectedEntityKeys: ['amount'], allowedConfidence: ['MEDIUM', 'HIGH'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'César aportó 200 mil.', expectedIntent: 'REGISTER_CAPITAL_CONTRIBUTION', expectedEntityKeys: ['amount', 'investorQuery'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Edgar metió 200 mil al negocio.', expectedIntent: 'REGISTER_CAPITAL_CONTRIBUTION', expectedEntityKeys: ['amount', 'investorQuery'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Registra 100 mil de aportación para César en Bancos.', expectedIntent: 'REGISTER_CAPITAL_CONTRIBUTION', expectedEntityKeys: ['amount', 'investorQuery', 'account'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Págale la utilidad a César.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', allowedConfidence: ['MEDIUM', 'LOW', 'HIGH'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Págale 100 mil de utilidad a César.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', expectedEntityKeys: ['amount'], allowedConfidence: ['MEDIUM', 'HIGH'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Registra una distribución de 50 mil para Edgar.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', expectedEntityKeys: ['amount', 'investorQuery'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Registra 100 mil de distribución para Edgar en Bancos.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', expectedEntityKeys: ['amount', 'investorQuery', 'account'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Retira 100 mil para César de sus utilidades.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', expectedEntityKeys: ['amount'], allowedConfidence: ['MEDIUM', 'HIGH'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'José nos debe 50 mil.', expectedIntent: 'CREATE_RECEIVABLE', expectedEntityKeys: ['amount', 'counterpartyName'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Registra una cuenta por cobrar de 100 mil a Pepe.', expectedIntent: 'CREATE_RECEIVABLE', expectedEntityKeys: ['amount'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Le debemos 80 mil a José.', expectedIntent: 'CREATE_PAYABLE', expectedEntityKeys: ['amount', 'counterpartyName'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Registra una cuenta por pagar de 40 mil a Pepe.', expectedIntent: 'CREATE_PAYABLE', expectedEntityKeys: ['amount'], allowedConfidence: ['HIGH', 'MEDIUM'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Págale 100 mil a José que le debemos.', expectedIntent: 'REGISTER_PAYABLE_PAYMENT', expectedEntityKeys: ['amount'], allowedConfidence: ['MEDIUM', 'HIGH', 'LOW'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
  { category: 'WRITE_DETECTION_ONLY', text: 'Dale 100 mil de utilidad a Edgar.', expectedIntent: 'REGISTER_CAPITAL_DISTRIBUTION', expectedEntityKeys: ['amount'], allowedConfidence: ['MEDIUM', 'HIGH'], mayProceedToOrchestrator: true, executionMustBeImpossible: true },
