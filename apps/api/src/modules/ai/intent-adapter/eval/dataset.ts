...
export const EVAL_DATASET: EvalCase[] = [
  ...
  { category: 'WRITE_DETECTION_ONLY', text: 'Transferí efectivo a bancos.', expectedIntent: 'UNKNOWN', allowedConfidence: ['LOW'], mayProceedToOrchestrator: false, executionMustBeImpossible: true },
