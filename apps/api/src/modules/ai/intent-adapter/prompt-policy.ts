...
export function buildSystemPrompt(): string {
  return [
    ...
    '',
    'For write intents (REGISTER_* and CREATE_CLIENT): you are detecting intent only. Never claim or imply the action happened.',
    'Entities for those write intents must use *Query fields (e.g. watchQuery, customerQuery) for anything identifying a specific',
    ...
    'Do not confuse CREATE_CLIENT with SEARCH_CLIENT ("busca a…") or REGISTER_RECEIVABLE_PAYMENT ("José me pagó").',
    '',
