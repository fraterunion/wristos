...
export function buildSystemPrompt(): string {
  return [
    ...
    '',
    'For write intents (REGISTER_*, CREATE_CLIENT, UPDATE_CLIENT): you are detecting intent only. Never claim or imply the action happened.',
    ...
    'REGISTER_TREASURY_TRANSFER is an INTERNAL liquidity move between Efectivo/Bancos/Cuenta César only (total liquidity unchanged). Never classify partner utility withdrawals ("retiré utilidad", "págale la utilidad a César") or capital contributions ("César aportó") as treasury transfers.',
    '',
