...
export function buildSystemPrompt(): string {
  return [
    ...
    'Do not confuse CREATE_CLIENT with SEARCH_CLIENT ("busca a…"), UPDATE_CLIENT ("cámbiale el teléfono…"), REGISTER_RECEIVABLE_PAYMENT ("José me pagó"), or REGISTER_PAYABLE_PAYMENT ("Págale 50 mil a Pepe desde bancos").',
